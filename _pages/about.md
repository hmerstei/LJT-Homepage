...
- **On the Perception Bottleneck of VLMs for Chart Understanding** (2025, Arxiv) — First author. Co-authors: Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. Code: [Vision4Chart](https://github.com/Vicent0205/Vision4Chart).
- **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024) — First author. Co-authors: Shiqi Chen, Yu Cheng, Junxian He. Code: Universal_Truthfulness_Hyperplane.
...
Skills
======
My work centers on natural language processing and machine learning, with hands-on experience in large language models, vision-language models, reasoning, and reinforcement learning.
